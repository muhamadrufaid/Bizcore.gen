...
const InvoiceDeliveryEditView = ({ onDeliveryDetailsChange, closePopup, deliveryData, selectedCustomer }) => {
    ...
    // This useEffect runs when the selected customer changes
    useEffect(() => {
        if (selectedCustomer) {
            setDelivery({
    ...
    const handleCheckboxChange = () => {
        setUseCustomerAddress(prevState => {
            ...
            if (newState) {
                // Populate address fields from selected customer
                if (selectedCustomer) {
    ...
    const handleInputChange = (e) => {
        ...
        setDelivery((prevState) => ({
            ...prevState,
            [name]: value,  // Update the field in the state
        }));
        onDeliveryDetailsChange({ ...delivery, [name]: value }); // Pass updated data to the parent
    };

    // Handle saving the delivery details
    const handleSave = () => {
...
export default InvoiceDeliveryEditView;

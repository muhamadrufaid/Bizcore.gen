...
const InvoiceDeliveryAdd = ({ onDeliveryDetailsChange, closePopup, deliveryData, selectedCustomer }) => {
  ...
  }, [deliveryData]); // This will run whenever deliveryData changes
  ...
  // Handle manual input changes for delivery details
...
export default InvoiceDeliveryAdd;

...
const DraftFinalizePaymentAddView = ({ setActiveSection, invoiceId, invoiceDetails, customerId, customerName, closePopupPayment, closePopupConfirmationView }) => {
    ...
    useEffect(() => {
        ...
        const calculatedBalanceDue = invoiceDetails?.remaining_balance - amountPaid;
        ...
        } else if (amountPaid > invoiceDetails?.grand_total) {
    ...
    const handlePaymentSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setActiveSection('invoice-view');  // Switch to the draft view
...
export default DraftFinalizePaymentAddView;
